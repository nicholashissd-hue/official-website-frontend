...
const SECTIONS: PrivacySection[] = [
  ...
  },
  {
    ...
    paragraphs: [
      "The Site does not operate a customer database. When you submit the contact form, your submission is converted into an email delivered to our team inbox (contact@elderops.net) and is retained there as ordinary business correspondence.",
    ],
  },
  {
