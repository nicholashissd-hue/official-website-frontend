...
const page: ServicePage = {
  ...
  embedded: {
    title: "Flexible leadership backed by delivery capability",
    paragraphs: [
      "A fractional leader should not become another layer between strategy and execution.",
      "ElderOps leaders work close to the engineering environment. They review designs, examine delivery evidence, participate in key operating forums, guide teams, resolve decisions, and stay accountable for agreed priorities. When a strategy requires additional capacity, the leader can bring in the cloud, platform, DevOps, security, reliability, data, or software engineers needed to deliver it.",
    ],
    modelsIntro: "Engagements can take the form of:",
    models: [
      "A focused advisory assessment.",
      "A retained fractional leadership role.",
      "Interim leadership during a transition or hiring process.",
      "Executive oversight for a critical program.",
      "A build-operate-transfer model that establishes a capability and transitions it to permanent internal leadership.",
    ],
  },
  ...
  faqs: [
    {
      q: "How much time does a fractional leader spend with us?",
      a: "The commitment is structured around the responsibility. Some organizations need a focused number of days each month; others need an embedded interim leader for a defined period. Scope, availability, decision rights, and expected outcomes are agreed at the outset.",
    },
    {
      q: "Is fractional leadership only for startups?",
      a: "No. It can support startups, growth-stage businesses, mid-market companies, and enterprises. Larger organizations often use fractional or interim leadership for transformations, capability gaps, independent assessments, and major programs.",
    },
    {
      q: "Can the advisor also provide engineers?",
      a: "Yes. Where execution requires additional expertise, ElderOps can embed specialists or a multidisciplinary squad. Leadership and delivery remain aligned around the same priorities.",
    },
    {
      q: "Can you support us while we recruit a permanent leader?",
      a: "Yes. An ElderOps leader can provide continuity, stabilize priorities, assess the organization, support the recruitment process, and prepare a structured transition for the permanent hire.",
    },
  ],
};
