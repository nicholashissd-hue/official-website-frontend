...
const Hero = () => {
  return (
    <section className="grain relative overflow-hidden bg-primary lg:flex lg:min-h-screen lg:flex-col lg:pt-20">
      ...
      <div
        aria-hidden="true"
        className="pointer-events-none absolute inset-0 bg-[radial-gradient(50%_55%_at_78%_42%,rgba(6,156,78,0.14)_0%,transparent_70%)]"
      />
      <div
        aria-hidden="true"
      ...
      <div className="container relative grid w-full grid-cols-1 items-center gap-14 pb-20 pt-36 md:pt-44 lg:flex-1 lg:content-center lg:grid-cols-[1fr_1.05fr] lg:gap-12 lg:py-10">
        <div>
          <Reveal immediate delay={0.05} y={26}>
            <h1 className="font-display text-[clamp(2.5rem,5.4vw,5rem)] font-semibold leading-[1.04] tracking-[-0.02em] text-bg-cream">
