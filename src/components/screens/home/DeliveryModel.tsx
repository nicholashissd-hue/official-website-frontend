          ...
          <div className="grid content-between gap-5">
            {servicesData.map((service, index) => (
              <Reveal
                key={service.id}
                delay={index * 0.08}
                className="flex gap-6 rounded-3xl bg-white p-7 ring-1 ring-primary/10 transition-all duration-500 hover:-translate-y-1 hover:shadow-[0_24px_50px_rgba(2,54,27,0.1)] md:p-8"
              >
