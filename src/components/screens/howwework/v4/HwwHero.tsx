...
import heroImage from "@/assets/webp/v4/hero-hww-dusk.webp";
import heroImage1600 from "@/assets/webp/v4/hero-hww-dusk-1600.webp";
import heroImage828 from "@/assets/webp/v4/hero-hww-dusk-828.webp";
import { hero } from "@/contents/screens/howWeWorkV4";
...
/** Dark photo hero: the office at dusk, the method as the statement. */
const HwwHero = () => (
  <section className="relative flex min-h-[92svh] flex-col justify-end overflow-hidden bg-nearblack">
    <img
      ...
      sizes="100vw"
      alt="ElderOps data engineers working together around a boardroom table in the evening"
